  ...
  return (
    <>
      ...
      <button
        ...
        ref={searchButtonRef}
        onClick={onOpen}
        className="flex items-center w-full py-2 space-x-3 font-mono font-medium leading-6 transition-colors duration-200 group sm:space-x-4 hover:text-gray-600"
      >
        <svg
          width="24"
          height="24"
