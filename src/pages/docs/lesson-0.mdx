...
These three steps were sourced from [Jennifer Gonzalez](https://www.cultofpedagogy.com/backward-design-basics/). Ms. Gonzalez's analysis includes fantastic examples on why Backwards Design is so important for student growth. Feel free to read through to get a better understanding of why Treetop Learning employs Backwards Design throughout its instruction.
...
- * Why do you think that Lorem Ipsum is so widely used today?*
