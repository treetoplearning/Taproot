...
<template preview>
  <form class="flex w-full max-w-sm mx-auto space-x-3">
    <input class="flex-1 w-full px-4 py-2 text-base text-gray-700 placeholder-gray-400 bg-white border border-transparent rounded-lg shadow-md appearance-none focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent" type="email" placeholder="Your email">
...
<template preview>
  <div class="text-center">
    <button type="button" class="px-4 py-2 font-semibold text-white bg-red-500 rounded-lg shadow-md hover:bg-red-700 focus:outline-none" tabindex="-1">
      Hover me
    </button>
  </div>
</template>
...
<template preview>
  <div class="w-full max-w-xs mx-auto">
    <input class="inline-block w-full px-4 py-3 text-gray-900 placeholder-gray-400 bg-white rounded-lg shadow-md appearance-none focus:outline-none focus:ring-2 focus:ring-blue-600" placeholder="Focus me">
  </div>
</template>
...
<template preview>
  <div class="text-center">
    <button type="button" class="px-4 py-2 font-semibold text-white rounded-lg shadow-md bg-emerald-500 active:bg-emerald-700 focus:outline-none" tabindex="-1">
      Click me
    </button>
  </div>
</template>
...
```html indigo
<template preview>
  <div class="max-w-full px-6 py-5 mx-auto space-y-1 overflow-hidden border border-indigo-500 border-opacity-25 rounded-lg cursor-pointer select-none group w-72 hover:bg-white hover:shadow-lg hover:border-transparent">
    <p class="text-lg font-semibold text-indigo-600 group-hover:text-gray-900">New Project</p>
...
<template preview>
  <div class="text-center">
    <button type="button" class="inline-flex items-center px-4 py-2 font-semibold text-white rounded-lg shadow-md group bg-amber-500 focus:bg-amber-600 focus:outline-none">
      <svg fill="currentColor" viewBox="0 0 20 20" class="w-5 h-5 mr-3 -ml-1 text-white group-focus:text-amber-300"><path d="M5 4a2 2 0 012-2h6a2 2 0 012 2v14l-5-2.5L5 18V4z"></path></svg>
      Bookmark
    </button>
  </div>
</template>
...
<template preview>
  <form class="w-full max-w-sm mx-auto">
    <div class="relative text-gray-400 focus-within:text-gray-600">
      ...
      <input id="email" class="block w-full px-4 py-3 pl-12 text-gray-900 placeholder-gray-400 bg-white rounded-lg shadow-md appearance-none focus:outline-none" placeholder="you@example.com">
    </div>
  </form>
</template>
...
<template preview>
  <div class="flex justify-center space-x-8">
    <button type="button" class="px-4 py-2 font-semibold text-white bg-red-500 rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:bg-red-500 focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-opacity-75">
      Ring on focus
    </button>
    <button type="button" class="px-4 py-2 font-semibold text-white bg-red-500 rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:bg-red-500 focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:ring-offset-2 focus-visible:ring-opacity-75">
...
<template preview>
  <div class="text-center">
    <button type="button" class="px-4 py-2 font-semibold text-white transition duration-500 transform rounded-lg shadow-md bg-light-blue-500 motion-safe:hover:scale-110 focus:outline-none" tabindex="-1">
      Hover me
    </button>
  </div>
</template>
...
<template preview>
  <div class="text-center">
    <button type="button" class="px-4 py-2 font-semibold text-white transition duration-500 transform rounded-lg shadow-md bg-fuchsia-500 motion-reduce:transform-none hover:scale-110 focus:outline-none" tabindex="-1">
      Hover me
    </button>
  </div>
</template>
...
<template preview>
  <div class="space-x-8 text-center">
    <button type="button" class="px-4 py-2 font-semibold text-white rounded-lg shadow-md bg-emerald-500 hover:bg-emerald-700 focus:outline-none disabled:opacity-50" tabindex="-1">
      Submit
    </button>
    <button type="button" class="px-4 py-2 font-semibold text-white rounded-lg shadow-md bg-emerald-500 disabled:opacity-50" disabled tabindex="-1">
      Submit
    </button>
  </div>
</template>
...
```html lightBlue
<template preview>
  <div class="max-w-xs p-4 mx-auto bg-white shadow-md rounded-xl">
    <label class="flex items-center space-x-3">
      <input type="checkbox" name="checked-demo" value="1" class="w-6 h-6 border border-gray-300 rounded-md appearance-none form-tick checked:bg-blue-600 checked:border-transparent focus:outline-none">
...
<template preview>
  <div class="flex justify-around">
    <div class="p-8 transform bg-indigo-500 rounded-md first:rotate-45"></div>
    <div class="p-8 transform bg-indigo-500 rounded-md first:rotate-45"></div>
    <div class="p-8 transform bg-indigo-500 rounded-md first:rotate-45"></div>
    <div class="p-8 transform bg-indigo-500 rounded-md first:rotate-45"></div>
  </div>
...
<template preview>
  <div class="flex justify-around">
    <div class="p-8 transform rounded-md bg-amber-500 last:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-amber-500 last:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-amber-500 last:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-amber-500 last:rotate-45"></div>
  </div>
...
<template preview>
  <div class="flex justify-around">
    <div class="p-8 transform rounded-md bg-rose-500 odd:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-rose-500 odd:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-rose-500 odd:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-rose-500 odd:rotate-45"></div>
  </div>
...
<template preview>
  <div class="flex justify-around">
    <div class="p-8 transform rounded-md bg-fuchsia-500 even:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-fuchsia-500 even:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-fuchsia-500 even:rotate-45"></div>
    <div class="p-8 transform rounded-md bg-fuchsia-500 even:rotate-45"></div>
  </div>
