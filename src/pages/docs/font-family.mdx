...
Use `font-mono` to apply a web safe sans-serif font family:

```html lightBlue
<template preview>
  <p class="font-mono text-xl text-center text-light-blue-600">
...
```html emerald
<template preview>
  <p class="font-serif text-xl text-center text-emerald-600">
    The quick brown fox jumps over the lazy dog.
  </p>
</template>
...
```html indigo
<template preview>
  <p class="font-mono text-xl text-center text-indigo-600">
    The quick brown fox jumps over the lazy dog.
  </p>
</template>
...
```html
<p class="font-mono **md:font-serif**">
  <!-- ... -->
</p>
```
